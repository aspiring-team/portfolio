...
const ProjectCard: FC<ProjectCardProps> = memo(
  ({ id, description, image, title }) => {
    return (
      <div className="flex flex-col-reverse items-center justify-center space-x-0 space-y-4 md:flex-row md:space-x-9 md:space-y-0">
        <div className="mt-4 flex flex-col space-y-5 md:mt-0">
